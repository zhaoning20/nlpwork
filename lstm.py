...
class PTBInput(object):
    ...
    def __init__(self, config, data, name=None):
        ...
        self.input_data, self.targets = readers.ptb_producer(data, batch_size, num_steps, name=name)
...
raw_data = readers.ptb_raw_data('E:\研究生上课资料及作业\语言分析与机器翻译\data')  # 直接读取解压后的数据
